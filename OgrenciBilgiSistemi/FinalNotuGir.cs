...
{
    public partial class FinalNotuGir : Form
    {
        MySqlDataAdapter dr;
        MySqlConnection con;
        MySqlCommand cmd;
        ...
        private void FinalNotuGir_Load(object sender, EventArgs e)
        {
                    ...
                    if (comboBox1.Text.ToString() != "")
                    {
                        ...
                        try
                        {
                            ...
                            else
                            {
                                ...
                                cmd = new MySqlCommand();
                                cmd.Connection = con;
                                cmd.CommandText = "INSERT INTO final(ogrNo,dersNo,FinalNotu) VALUES ('" + textBox1.Text + "','" + dersKodu + "','" + Final + "')";
                                try
                                {
                                    de = cmd.ExecuteReader();
                                    MessageBox.Show("Final Notu Girildi.");
                                }
                                catch (Exception)
                                {
